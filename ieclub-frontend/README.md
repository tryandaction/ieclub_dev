...
这是 IEClub 的微信小程序端，使用**原生微信小程�?*技术开发�?
### 为什么选择原生开发？

1. �?**稳定可靠** - 没有跨平台框架的兼容性问�?2. �?**性能最�?* - 零框架层开销，运行速度�?3. �?**调试方便** - 直接使用微信开发者工具，问题定位�?4. �?**官方支持** - 完整的文档和社区支持
5. �?**学习成本�?* - 代码简单清晰，易于维护
...
1. 启动微信开发者工�?2. 选择"导入项目"
3. 项目目录选择当前文件�?4. AppID 选择"测试�?或输入你�?AppID
5. 点击"导入"
...
├── sitemap.json             # 搜索配置
�?├── pages/                    # 页面目录
�?  ├── plaza/               # 话题广场�?�?  �?  ├── index.js         # 页面逻辑
�?  �?  ├── index.wxml       # 页面结构
�?  �?  ├── index.wxss       # 页面样式
�?  �?  └── index.json       # 页面配置
�?  �?�?  ├── community/           # 社区�?�?  ├── activities/          # 活动�?�?  ├── publish/             # 发布�?�?  └── profile/             # 个人中心�?�?└── assets/                  # 静态资�?    └── icons/               # 图标（TabBar等）
```
...
## 🐛 调试技�?
### 1. 控制台调�?
在微信开发者工具中打开"调试�? �?"Console"，可以查�?`console.log` 输出�?
### 2. 查看数据

�?调试�? �?"AppData" 中可以实时查看页面数据�?
### 3. 网络请求

�?调试�? �?"Network" 中可以查看所有网络请求�?
### 4. 真机调试
...
1. **AppID**: 首次使用请在 `project.config.json` 中填写你�?AppID
2. **域名配置**: 正式环境需要在小程序管理后台配置服务器域名
3. **体验�?*: 开发完成后可以上传代码生成体验版供他人测试
