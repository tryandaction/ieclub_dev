// frontend/src/components/CustomIcons/index.jsx
import { View } from '@tarojs/components';
import './index.scss';

// 广场图标
export const SquareIcon = ({ active, size = 24 }) => (
...
// 社区图标
export const CommunityIcon = ({ active, size = 24 }) => (
...
// 通知图标
export const NotificationIcon = ({ active, size = 24, hasUnread = false }) => (
...
// 个人主页/我的图标
export const ProfileIcon = ({ active, size = 24 }) => (
...
// 默认头像图标
export const DefaultAvatarIcon = ({ size = 40 }) => (
...
// 默认封面图标
export const DefaultCoverIcon = ({ width = '100%', height = '160px' }) => (
