...
const CommunityPage: React.FC = () => {
  ...
  return (
    <View className="community-page">
      ...
      {/* 智能匹配入口（第三版本新增） */}
      <View 
        className="community-page__matching-entry"
        onClick={() => Taro.navigateTo({ url: '/pages/community/matching/index' })}
      >
        <View className="matching-entry">
          <View className="matching-entry__icon">✨</View>
          <View className="matching-entry__content">
            <Text className="matching-entry__title">智能匹配</Text>
            <Text className="matching-entry__desc">找到最相似的伙伴</Text>
          </View>
          <View className="matching-entry__arrow">›</View>
        </View>
      </View>
      ...
      >
        {users.length > 0 ? (
          ...
          <EmptyState
            icon="👥"
            message={searchKeyword ? '没有找到相关用户' : '暂无用户'}
          />
        )}
      </ScrollView>
    </View>
