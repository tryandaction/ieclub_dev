...
import { Bell, Lock, Eye, EyeOff, Shield, Info, Trash2, Download, Smartphone } from 'lucide-react'
            ...
            <div className="space-y-4">
              {isInstalled ? (
                <div className="flex items-center gap-3 p-4 bg-green-50 rounded-xl">
                  ...
                  <div>
                    <div className="text-sm font-medium text-green-800">IEClub 已安装</div>
                    <div className="text-xs text-green-600">您正在使用独立应用</div>
                  </div>
                </div>
              ) : isInstallable ? (
                <div className="flex items-center justify-between p-4 bg-purple-50 rounded-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-medium text-gray-900">安装 IEClub</div>
                      <div className="text-xs text-gray-500">添加到主屏幕，获得更好体验</div>
                    </div>
                  </div>
                  <button
                    onClick={install}
                    className="flex items-center gap-1.5 bg-purple-600 text-white px-4 py-2 rounded-full text-sm font-medium hover:bg-purple-700 transition-colors"
                  >
                    <Download size={16} />
                    安装
                  </button>
