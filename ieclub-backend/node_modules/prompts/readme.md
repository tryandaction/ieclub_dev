...
<p align="center">
  ...
  <sub>>_ Easy to use CLI prompts to enquire users for information‚ñ?/sub>
</p>
...
Use <kbd>‚á?/kbd>/<kbd>‚á?/kbd> to navigate. Use <kbd>tab</kbd> to cycle the result. Use <kbd>Page Up</kbd>/<kbd>Page Down</kbd> (on Mac: <kbd>fn</kbd> + <kbd>‚á?/kbd> / <kbd>‚á?/kbd>) to change page. Hit <kbd>enter</kbd> to select the highlighted item below the prompt.
