...
export const request = {
  get: <T = any>(url: string, params?: any, options?: any) =>
    enhancedRequest<T>({ url, method: 'GET', data: params, ...options }),

  post: <T = any>(url: string, data?: any, options?: any) =>
    enhancedRequest<T>({ url, method: 'POST', data, ...options }),

  put: <T = any>(url: string, data?: any, options?: any) =>
    enhancedRequest<T>({ url, method: 'PUT', data, ...options }),

  delete: <T = any>(url: string, data?: any, options?: any) =>
    enhancedRequest<T>({ url, method: 'DELETE', data, ...options })
}