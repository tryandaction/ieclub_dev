...
const Sidebar = () => {
  ...
  return (
    <div className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:left-0 lg:top-0 lg:h-screen lg:bg-white lg:border-r lg:border-gray-200">
      {/* Logo */}
      ...
      <nav className="flex-1 py-6 px-3 space-y-1">
        ...
        <button
          ...
          className="w-full mt-4 px-4 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-xl font-medium hover:shadow-lg transition-all duration-200"
        >
          发布
        </button>
      </nav>
