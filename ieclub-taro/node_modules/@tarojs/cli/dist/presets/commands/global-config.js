...
exports.default = (ctx) => {
    ctx.registerCommand({
        ...
        fn({ _ }) {
            ...
            const rootPath = (0, util_1.getRootPath)();
            ...
            function addOrRemovePresetOrPlugin(actionType, pluginType) {
                ...
                const pluginWithoutVersionName = (0, util_1.getPkgNameByFilterVersion)(pluginName);
                    ...
                    successCallback(data) {
                        ...
                        const pluginIndex = configItem.findIndex((item) => {
                            if (typeof item === 'string')
                                return item === pluginWithoutVersionName;
                            if (item instanceof Array)
                                return (item === null || item === void 0 ? void 0 : item[0]) === pluginWithoutVersionName;
                        });
            ...
            switch (action) {
                ...
                case 'reset':
                    if (fs.existsSync(globalPluginConfigDir))
                        fs.removeSync(globalPluginConfigDir);
                    fs.copySync(templatePath, globalPluginConfigDir);
                    break;
                default:
