...
class H5Combination extends Combination_1.Combination {
    ...
    process(config) {
        ...
        const { entry = {}, output = {}, entryFileName = 'app', mode = 'production', sourceMapType = 'eval-cheap-module-source-map', publicPath = '/', chunkDirectory = 'chunk', alias = {}, defineConstants = {}, router, frameworkExts } = config;
        const externals = [];
