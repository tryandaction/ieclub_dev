...
/* harmony import */ var _chunk_3ZJKPIIU_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-3ZJKPIIU.js */ "./node_modules/.taro/weapp/prebundle/chunk-3ZJKPIIU.js");
/* harmony import */ var _chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-RP3FZJJN.js */ "./node_modules/.taro/weapp/prebundle/chunk-RP3FZJJN.js");
...
/* provided dependency */ var navigator = __webpack_require__(/*! ./node_modules/.taro/weapp/prebundle/chunk-3ZJKPIIU.js */ "./node_modules/.taro/weapp/prebundle/chunk-3ZJKPIIU.js")["nav"];
...
(0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.init_shared_esm)();
(0,_chunk_3ZJKPIIU_js__WEBPACK_IMPORTED_MODULE_1__.init_runtime_esm)();
...
function getUpdatePayload(dom, oldProps, newProps) {
    ...
    const isFormElement = dom instanceof _chunk_3ZJKPIIU_js__WEBPACK_IMPORTED_MODULE_1__.FormElement;
    for(i in newProps){
...
function setEvent(dom, name, value, oldValue) {
    ...
    const compName = (0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.capitalize)((0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.toCamelCase)(dom.tagName.toLowerCase()));
    if (eventName === "click" && compName in _chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.internalComponents) {
        eventName = "tap";
    }
    if ((0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(value)) {
        if (oldValue) {
...
function setStyle(style, key, value) {
    ...
    style[key] = (0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.isNumber)(value) && IS_NON_DIMENSIONAL.test(key) === false ? value + "px" : value == null ? "" : value;
}
function setProperty(dom, name, value, oldValue) {
    ...
    if (name === "key" || name === "children" || name === "ref") ;
        ...
        if ((0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.isString)(value)) {
            style.cssText = value;
        } else {
            if ((0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.isString)(oldValue)) {
                style.cssText = "";
                oldValue = null;
            }
            if ((0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(oldValue)) {
            ...
            if ((0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.isObject)(value)) {
    ...
    } else if (!(0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(value)) {
        if (value == null) {
...
var hostConfig = {
    ...
    resetAfterCommit: _chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    createInstance (type, props, _rootContainerInstance, _hostContext, internalInstanceHandle) {
        const element = _chunk_3ZJKPIIU_js__WEBPACK_IMPORTED_MODULE_1__.document$1.createElement(type);
    ...
    finalizeInitialChildren (dom, type, props) {
        let newProps = props;
        if (dom instanceof _chunk_3ZJKPIIU_js__WEBPACK_IMPORTED_MODULE_1__.FormElement) {
    ...
    createTextInstance (text, _rootContainerInstance, _hostContext, internalInstanceHandle) {
        const textNode = _chunk_3ZJKPIIU_js__WEBPACK_IMPORTED_MODULE_1__.document$1.createTextNode(text);
    ...
    beforeActiveInstanceBlur: _chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    afterActiveInstanceBlur: _chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    preparePortalMount: _chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    prepareScopeUpdate: _chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    getInstanceFromScope: ()=>null,
    getCurrentEventPriority () {
        return import_constants.DefaultEventPriority;
    },
    detachDeletedInstance: _chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    // -------------------
    //      Microtasks
    //     (optional)
    // -------------------
    supportsMicrotasks: true,
    scheduleMicrotask: (0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.isUndefined)(Promise) ? setTimeout : (callback)=>Promise.resolve(null).then(callback).catch(function(error) {
            setTimeout(()=>{
                throw error;
            });
        }),
    ...
    commitMount: _chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    ...
    resetTextContent: _chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.noop,
    ...
    unhideInstance (instance, props) {
        ...
        display = display == null || (0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.isBoolean)(display) || display === "" ? "" : ("" + display).trim();
...
function createRoot(domContainer, options = {}) {
    ...
    _chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.hooks.tap("dispatchTaroEvent", (e, node)=>{
        const eventPriority = getEventPriority(e.type);
        TaroReconciler.runWithPriority(eventPriority, ()=>{
            node.dispatchEvent(e);
        });
    });
    _chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.hooks.tap("modifyTaroEvent", (e, node)=>{
        var _a2, _b;
...
function unmountComponentAtNode(dom) {
    (0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.ensure)(dom && [
        1,
        8,
        9,
        11
...
var portalType = (0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(Symbol) && Symbol.for ? Symbol.for("react.portal") : 60106;
