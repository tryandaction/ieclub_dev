...
function initNativeApi(taro) {
    (0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_0__.processApis)(taro, wx, {
        needPromiseApis,
        modifyApis (apis) {
...
var hostConfig = {
    ...
    transferHydrateData (data, element, componentsAlias) {
        ...
        if (element.isTransferElement) {
            ...
            page.setData({
                [(0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_0__.toCamelCase)(data.nn)]: data
            });
            return {
                sid: element.sid,
                ["v"]: "",
...
(0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_0__.mergeReconciler)(hostConfig);
(0,_chunk_RP3FZJJN_js__WEBPACK_IMPORTED_MODULE_0__.mergeInternalComponents)(components);
